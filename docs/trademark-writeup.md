...
> Kenya Industrial Property Institute). It describes the marks, the services,
...
## 1. The marks to protect

Consider protecting these as a small family of marks (your attorney will advise
which to file, and whether as word marks, a device/logo mark, or a composite):
...
- **Mutual-consent, non-anonymous messaging** with content moderation, reporting
  and blocking, and a crisis-safety escalation pathway.
- A **Learning Academy** of relationship-education courses; **Wellness Tools**
  (mood tracking, guided breathing, gratitude journal, affirmations,
  check-ins); a **Listening Centre** (non-clinical listening support); and a
  **Couple Space** (shared journal, goals, budgeting, date planning) unlocked on
  mutual commitment.
- **Counsellor support** — booking counselling sessions (video/phone/in person),
...
## 5. Suggested classes (Nice Classification) — **confirm with attorney**

A platform like this typically spans several classes. Likely candidates:

| Class | Covers | Why |
|---|---|---|
| **9** | Downloadable mobile application software | The app itself. |
| **42** | Software-as-a-service; hosting; software design | The online platform / SaaS. |
| **45** | Online social-networking, dating and introduction services; personal & social services | The matchmaking / relationship service — often the core class here. |
| **44** | Counselling (psychological/health), mental-health & wellness services | The counsellor-guided, wellness and listening elements. |
| **41** | Education, training, coaching; webinars; workshops | The Academy, courses, events and marriage-prep. |

Filing across multiple classes costs more; your attorney will help prioritise
(commonly **45 + 42 + 44** first for this kind of service).

## 6. Distinctiveness & strength — an honest assessment
...
- **Stage:** in active development; a public demo is live (see §9). Not yet
...
## 8. Applicant details (to complete)

| Field | Value |
|---|---|
| Legal owner (individual or company) | ______________________ |
| Registration / ID no. | ______________________ |
| Address (Kenya) | ______________________ |
| Contact email / phone | ______________________ |
| Preferred trademark agent / attorney | ______________________ |

*Tip: file in the name of the entity (company) that will own and operate the
brand, if one exists or is planned.*
...
5. **Choose the territory strategy:** Kenya first (KIPI); consider **ARIPO** for
   multiple African states, or **WIPO Madrid** for international, if expansion is
   planned.
6. **Secure surrounding assets** in parallel: domain names, social handles, and
   the app-store names — squatting risk rises once you launch publicly.
7. **File**, then diarise the renewal (Kenya marks run in renewable terms) and
